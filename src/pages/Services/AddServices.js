...
function AddSurviceForm(props) {
  ...
  console.log(JSON.stringify(dataToSend));
    ...
    fetch('https://service-hotelmanagement-dev.azurewebsites.net/api/dichvus', {
      method: 'POST',
      ...
      .then((data) => {
        ...
        props.onAddService(newService); // Pass the new surcharge data
        props.onCancel();
